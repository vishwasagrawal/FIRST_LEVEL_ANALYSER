...
public class UpdateURL {
	...
	private static void FetchStatusFromApplication(WebDriver driver) throws Exception 
	{
		...
		for(int i=FirstRow;i<=LastRow;i++) 
		{
			...
			if (!driver.findElements(By.xpath(".//ul[@id='masterPageId--list-listUl']//li[1]//div[3]//span[1]")).isEmpty())	{
				...
				TempStatus = driver.findElement(By.xpath(".//ul[@id='masterPageId--list-listUl']//li[1]//div[3]//div[1]//div[1]//div[1]")).getText();
				//	Status1 = TempStatus.split("\\r?\\n"); //split in array timestamp and status values.
					...
					String ExeTime = driver.findElement(By.xpath(".//ul[@id='masterPageId--list-listUl']//li[1]//div[3]//div[2]")).getText();
					TimeUnit.SECONDS.sleep(2);
				...
				System.out.println("Status for the script " +data0+ " is " +TempStatus+ "." ); //print in console status of each script
			}
	...
	private static void LoginToWebApplication(WebDriver driver, String username, String password) throws InterruptedException 
	{
